...
preamble: >
  The Nelson team has tried to ensure that the on-going operator burden of the system is as minimal as possible. To achive this, we have front-loaded some of the operator complexity and it is important to read through this documentation understand the operational trade-offs that have been made.
menu:
  main:
