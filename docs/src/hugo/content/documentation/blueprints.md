...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Name of the unit you are attempting to deploy. For example <code>foo</code> or <code>foo-bar</code>. Never includes spaces or special characters and must adher to sanitization per ITEF RFC 1035</td>
      <td><code>*</code></td>
    </tr>
    <tr>
      <td><code>version</code></td>
      <td>The version of this particular unit being deployed. Typically a semantic version of the form 1.2.3, 4.53.44 etc</td>
      <td><code>*</code></td>
    </tr>
  </tbody>
</table>
...
<table class="table table-striped">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>What filesystem path should the volume be mounted too</td>
      <td><code>empty_volumes_list</code></td>
    </tr>
    <tr>
      <td><code>empty_volume_mount_size</code></td>
      <td>How large should the specified volume be, defined in megabytes</td>
      <td><code>empty_volumes_list</code></td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>empty_volumes_list</code></td>
      <td>Handle for traversing the port list, and accessing the <code>empty_volume_mount_size</code>, <code>empty_volume_mount_name</code> and <code>empty_volume_mount_path</code> fields</td>
      <td><code>empty_volumes</code></td>
    </tr>
    <tr>
