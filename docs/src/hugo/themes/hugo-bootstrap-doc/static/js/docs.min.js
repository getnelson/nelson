$(function(){
  ...
  $('h1.page-header').each(function(){
    var h1 = $(this);
    var h1id = h1.attr('id');
    var subs = $('[data-subheading-of='+h1id+']');
    if (h1.length){
      html+= '<li><a href="#' + h1id +'">'+ h1.text() +'</a>';
      if (subs.length) {
        html+= '<ul class="nav">';
        subs.each(function() {
  ...
  $('h3.linkable').each(function(){
    var h3 = $(this);
    var h3id = h3.attr('id');
    var elem = '<a class="anchor" href="#'+h3id+'" aria-hidden="true"><span class="glyphicon glyphicon-link" aria-hidden="true"></span></a>'
    h3.append(elem);
  });
