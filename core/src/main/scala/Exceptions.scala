...
final object NomadNotImplemented extends NelsonError(s"Nelson 0.11.x+ currently does not support Nomad. If you are interested in using Nelson with Nomad please reach out to us on Gitter: https://gitter.im/getnelson/nelson")
